...
C_SOURCES := kernel/kernel.c kernel/console.c kernel/framebuffer.c kernel/keyboard.c kernel/editor.c kernel/hwinfo.c kernel/exec.c kernel/snake.c kernel/clipboard.c drivers/ata.c fs/fat.c
